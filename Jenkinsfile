...
pipeline {
    ...
    parameters {
        ...
        string(name: 'LIVE_PACKAGER_HOST',defaultValue: '10.0.20.31', description: 'if the port is different from 80, please add :port to the host')
        string(name: 'VOD_PACKAGER_HOST',defaultValue: '10.0.20.31', description: 'if the port is different from 80, please add :port to the host')
        string(name: 'WWW_HOST',defaultValue: '10.0.20.31', description: 'if the port is different from 80, please add :port to the host')
